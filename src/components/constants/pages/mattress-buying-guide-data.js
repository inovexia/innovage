const MattressBuyingGuideData = () => {
  return {
    seoData: {
      ...
      description: `Mattress Buying Guide Page.`,
    },
    mattressGuideData: {
      mattressFoundation: {
      ...
      mattressSizes: {
        ...
        size1: `Single/Twin – 39″ x 75″ (inches)  –  99cm x 190.5cm (centimeters)`,
        size2: `Double/Full – 54″ x 75″ (inches)  –  137cm x 190.5cm (centimeters)`,
        ...
        description2: `<a href="https://www.mattressville.ca/product-category/type/pocket-coil/">Pocket coil mattresses</a> contain many individual springs, housed in fabric pockets, all working independantly of each other. This arrangement means that support is offered from the edge to the very centre of the mattress and means significantly less-roll together when two people are on it. Amounts of individual springs vary, the more pocket springs a mattress has, the more supportive it will be. Pocket coil mattresses can be a great investment, as they provide a supportive sleeping environment.`,
        subTitle3: `Memory Foam`,
        description3: `Famously developed by NASA in the 1960’s  <a href="https://www.mattressville.ca/product-category/style/memory-foam-style/">Memory Foam Mattresses</a> relieve pressure on the body by distributing your weight evenly, providing ultimate support. In Addition, the flexible structure of Memory Foam Mattresses means they can absorb movement and mould to your individual body shape for a great night’s sleep. Some customers have found memory foam to be too warm to sleep on, this is why there is an increase in popularity of our Formeflex Cool Gel memory foam mattresses, featuring the cooling properties of Thermo Cool Cover and Flex Gel Memory foam to regulate the temperature.`,
        subTitle4: `Latex mattress`,
        description4: `<a href="https://www.mattressville.ca/product-category/type/latex/">Latex</a> can be Natural (organic) and blend synthetic latex. Natural Latex is made of white milky sap juice which is tapped from the bark of the ‘Hevea Brasiliensis’ or Rubber Tree and probably is one of the most environmentally beneficial products in mattress industry that you can find.`,
        ...
        description6: `<a href="https://www.mattressville.ca/mattresses/style/organic-latex/">Natural latex mattresses</a> are also recommended for people who suffer from allergies, respiratory problems, hay fever, eczema and asthma. At the final stage of production natural latex goes through a double-washing process that makes it as contaminant free as it’s possible to get.`,
      },
    },
  }
}
